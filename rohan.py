...
bot = telebot.TeleBot('7751361737:AAH-CAz6LdUDnQl9pjPaVl5tIb5p_wXce68')
ADMIN_IDS = {"7438914699", "7242215923"}
CHANNEL_USERNAME = "@CAPTIONKIING"
FEEDBACK_CHANNEL = "@CAPTIONKING2"
PAID_CHANNEL = "@CAPTIONKING2"
CONTACT_ADMINS = ["@NEWWCARDER", "@CAPTIONALEX"]
...
🔥 Join @CAPTIONKING2 & @CAPTIONKIING to use!
...
def handle_attack(message):
    ...
    full_command = f"./attack {target} {port} {time_duration} 512 800"
    try:
